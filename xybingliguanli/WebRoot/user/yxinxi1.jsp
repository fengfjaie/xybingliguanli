...
<!--startprint-->
	<table id="dg" title="病历信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getYxinxis?yxinxiType=1&yhbumenId=<%=userId %>" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:deleteYxinxi()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">永远删除</a>
		</div>
		<div>
