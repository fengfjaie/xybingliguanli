...
var url;
	...
	function openUserModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑医生信息");
		$("#fm").form("load",row);
	...
	function daoruUsers(){
		$("#daoru").dialog("open").dialog("setTitle","导入医生信息");
		daoruurl="../daoruUser";
	}
	...
	function shangchuanUser(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传医生信息");
...
<!--startprint-->
	 ...
	 pagination="true" url="../getUsers" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="bumenId" width="20" hidden="true">科室ID</th>
				<th field="bumenName" width="40">科室</th>
				<th field="roleId" width="20" hidden="true">职位ID</th>
				<th field="roleName" width="40">职位</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		&nbsp;职位：&nbsp;<input class="easyui-combobox" id="s_roleId" name="s_roleId"  data-options="panelHeight:'auto',editable:false,valueField:'roleId',textField:'roleName',url:'../roleComboList'"/>
		&nbsp;科室：&nbsp;<input class="easyui-combobox" id="s_bumenId" name="s_bumenId"  data-options="panelHeight:'auto',editable:false,valueField:'bumenId',textField:'bumenName',url:'../bumenComboList'"/>
	...
	<div id="dlg" class="easyui-dialog" style="width: 540px;height: 220px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>职位：</td>
					<td><input class="easyui-combobox" id="roleId" name="roleId"  data-options="panelHeight:'auto',editable:false,valueField:'roleId',textField:'roleName',url:'../roleComboList'"/></td>
					<td>科室：</td>
