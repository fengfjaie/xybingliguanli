...
<!--startprint-->
	<table id="dg" title="病历信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getYxinxis?yxinxiType=0" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="dlg" class="easyui-dialog" style="width: 560px;height: 320px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				...
				<tr>
					<td>时间：</td>
					<td><input class="easyui-datetimebox" name="yxinxiDate" id="yxinxiDate" required="true" editable="false" /></td>
					<td>Yonghu：</td>
				...
				<tr>
					<td>备注1：</td>
					<td><input type="text" name="yxinxiMark1" id="yxinxiMark1" class="easyui-validatebox" required="true"/></td>
					<td>备注2：</td>
					<td><input type="text" name="yxinxiMark2" id="yxinxiMark2" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>类型1：</td>
					<td><select class="easyui-combobox" id="yxinxiType" name="yxinxiType" editable="false" panelHeight="auto" style="width: 155px">
					    <option value="">请选择...</option>
						<option value="0">零</option>
						<option value="1">一</option>
					</select></td>
					<td>类型2：</td>
					<td><select class="easyui-combobox" id="yxinxiType1" name="yxinxiType1" editable="false" panelHeight="auto" style="width: 155px">
					    <option value="">请选择...</option>
				...
				<tr>
					...
					<td colspan="4"><textarea rows="7" cols="50" name="yxinxiMark" id="yxinxiMark"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
